...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/ru.search-data.min.c5951a027da1dd111e68a9dadf2412708695ef018d03a4de9d45892390837a9a.js',function(){input.required=false;search();});}
